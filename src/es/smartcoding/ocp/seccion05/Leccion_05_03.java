 ...
 * 
 *         Muchas aplicaciones necesitan funcionar en diferentes paises con diferentes lenguas. Por ejemplo la fecha
 *         11/03/17 se refiere al 11 de marzo o al 3 de noviembre?
 * 
 *         Internacionalización (i18n) es el proceso de diseñar un software para que pueda ser adaptable a diferentes
 *         países.
 * 
 *         Localización (l10n) significa que un software soporta múltiples locales, entendiendo por local una lengua,
 *         cultura, sistema monetario, unidades de medida, etc.
 * 
 *         Oracle define un locale como un región geográfica, política o cultural específica. Dos letras minúsculas para
 *         la lengua, un subrallado, y dos letras mayúsculas para el país, por ejemplo es_ES para español de España.
 * 
 *         Es común centralizar las cadenas que utiliza una aplicación en un fichero externo, lo que se conoce como un
 *         Bundle, que justamente sigue esta nomenclatura. Con ello obtenemos dos ventajas:
 * 
 *         1.- Todas las cadenas están en un único lugar
 * 
 *         2.- Facilita la localización de una aplicación
 * 
...
public class Leccion_05_03 {
	 ...
	 * Resource Bundle
	 * 
	 * Un Resource Bundle o fichero de recursos contiene aspectos del programa susceptible de cambiar con el Locale:
	 * etiquetas, formatos de fechas, moneda...
	 * 
	 * Es decir, se trata de externalizar los recursos en un fichero o clase Java y NO incluirlos en el código.
	 * 
	 * Afortunadamente, no tenemos que escribir
	 */
	Locale locale4 = new Locale.Builder().setLanguage("es").build();
	Locale locale5 = Locale.ENGLISH;
	ResourceBundle bundle_es = ResourceBundle.getBundle("es.smartcoding.ocp.seccion05.l0503", locale4);
	ResourceBundle bundle_en = ResourceBundle.getBundle("es.smartcoding.ocp.seccion05.l0503", locale5);
	...
	/*
	 * La clase NumberFormat también tiene un método parse() que en función del locale interpretará las comas y los
	 * puntos como separadores de miles o como separador decimal.
	 */
	...
	/*
	 * A la hora de formatear fechas, las cosas se complican un poco. ISO es un estandar de representación de
	 * fechas. Pero el método ofLocalizedDate() de la clase DateTimeFormatter ofrece una representación más humana.
	 * 
	 */
	 ...
	 * 
	 * MMMM Representa el mes. Se puede especificar entre 1 y 4 M's con distintos resultados para el mes.
	 * 
	...
	/*
	 * Tambien hay un método parse() que puede utilizarse en combinación con el método ofPattern().
	 */
