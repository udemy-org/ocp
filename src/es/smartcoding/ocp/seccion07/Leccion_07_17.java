...
public class Leccion_07_17 {
     ...
     * @param args
     * 
     *            En el segundo stream, la Máquina Virtual Java selecciona el hilo que acaba antes, por lo que el
     *            resultado no es predecible.
     * 
     *            Las operaciones de stream que estan basadas en orden, como findFirst(), limit() o skip() pueden ser
     *            más lentas en entornos paralelos. El motivo es el esfuerzo adicional de sincronización de threads que
     *            debe hacerse.
     * 
     */
