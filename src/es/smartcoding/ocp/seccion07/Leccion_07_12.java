 ...
 *         esperan un cierto tiempo tanto para leer como para escribir un valor.
 * 
 * 
 *
 */
public class Leccion_07_12 {
	...
	public static void main(String[] args) {
		...
		/*
		 * En una BlockingQueue las inserciones se hacen detras y las
		 * eliminaciones y consultas en el princio. Para isertar un elemento
		 * tenemos los métodos offer() y put(). Y para consultar y recuperar
		 * elementos tenemos los métodos peek(), element() poll() y get(). Los
		 * metodos peek() y element() no elimina el elmento de la cola pero los
		 * métodos poll() y get() sí.
		 * 
		 */
		 ...
		 * 
		 * 1. Los que lanzan una excepción: addFirst(e), removeFirst() y
		 * getFirst() por una lado y addLast(e), removeLast(e) y getLast() por
		 * otro.
		 * 
		 * 2. Los que retornan un valor especial (null o false): offerFirst(e),
		 * pollFirst() y peekFirst() por una lado y offerLast(e), pollLast() y
		 * peekLast() por otro.
		 * 
		 * 3. Los que se bloquean indefinidamente hasta que la operación tiene
		 * éxito: putFirst(e) y takeFirst() por un lado y putLast(e) y
		 * takeLast() por otro.
		 * 
		 * 4. Los que se bloquean durante un límite máximo de tiempo:
		 * offerFirst(e, limit, unit) y pollFirst() por un lado y offerLast(e,
		 * limit, unit) y pollLast() por otro.
		 * 
		...
		/*
		 * Las clases ConcurrentSkipListSet y ConcurrentSkipListMap son las
		 * versiones concurrentes de las clases ordenadas TreeSet y TreeMap.
		 * 
