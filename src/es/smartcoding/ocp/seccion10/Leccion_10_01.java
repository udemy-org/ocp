 ...
 * 
 *         La API JDBC (Java Database Connectivity) se utiliza para acceder a bases de datos relacionales. Una base de
 *         datos relacional es una base de datos que organiza la información en tablas formadas por filas y columnas, al
 ...
 *         1. JDBC.
 * 
 *         2. JPA API. O lo que es lo mismo mediante un ORM (Object Relational Mapping).
 * 
 *         Se utiliza el lenguaje SQL (Structured Query Language) que se divide en dos partes DDL (Data Definition
 *         Language) y DML (Data Management Language). El primero se utiliza para crear estructuras de datos: create
 *         table ..., etc. El segundo se utiliza para acceder a bases de datos: select ...
 * 
 *         Otras bases de datos NoSQL no estructuran la información en forma de tablas como las llamadas base de datos
 *         documentales.
 * 
 *         Algunas de las operaciones básicas que se pueden hacer en un base de datos relacional son:
 * 
 ...
 * 
 *         Durante el examen OCP no necesitas ser un experto en SQL, basta que sepas interpretar instrucciones como
 *         esta:
 * 
