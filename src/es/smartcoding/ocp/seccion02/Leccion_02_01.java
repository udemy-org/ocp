 ...
 * 
 *         Las interfaces facilitan el desarrollo de software. Es un contrato
 *         que las clases que las implementan deben cumplir.
 * 
 *         Permite el prototipado rápido de una aplicación dejando los detalles
 *         de la implementación para más adelante.
 * 
 *         Algunas interfaces no declaran métodos, como java.io.Serializable, lo
 *         que se conoce como una interfaz de marca (marker interface).
 * 
 *         Otras, declaran exáctamente un único método abstracto (y posiblemente
 *         otros de tipo default y/o static). Son las interfaces funcionales que
