...
public class Leccion_03_06 {
	 ...
	 * 
	 * El método sort esta sobrecargado pero Java deduce del contexto de qué método se trata.
	 * 
	 * El método sort() de la clase Collections es un método estático que toma como parámetro una lista de objetos y
	 * que retorna void.
	 * 
	 */
	 ...
	 * 
	 * Elimina todos los objetos que una colección que cumplen una condición.
	 * 
	 * Cómo podría sustituirse (1) con una referencia a método?
	 * 
	 * Se trata de una pregunta con truco. No se puede, porque el método startsWith() requiere un parámetro que no
	 * es str.
	 * 
	 */
	 ...
	 * 
	 * La interfaz funcional UnaryOperator es una especialización de Function para cuando el parámetro y el
	 * resultado son del mmismo tipo.
	 * 
	 */
	 ...
	 * 
	 * Al parecer sólo el método merge() forma parte de los objetivos del examen OCP. Y otros dos computeIfPresent()
	 * y computeIfAbsent() forman parte de los objetivos del examen de actualización.
	 * 
	 ...
	 * La nueva API Map de Java 8
	 * 
	 * Java 8 ha añadido nuevos métodos a la interfaz Map. Pero sólo merge forma parte de los objetivos del examen
	 * OCP. Dos métodos más, computeIfPresent() y computeIfAbsent() forman parte de los objetivos del examen de
	 * actualización
	 * 
	 */
	 ...
	 * El método merge()
	 * 
	 * Algunas veces necesitamos más lógica a la hora de determinar qué valor asignar a una clave.
	 * 
	 * El método merge proporciona un mecanismo para añadir lógica sobre qué valor escoger.
	 */
	...
	/*
	 * En este caso la función de mapeo no se invoca, si se invocara lanzaría una NullPointerException.
	 */
	...
	/*
	 * Por ultimo debes tener en cuenta que si la función de mapeo retorna null, la clave se elimina del mapa.
	 */
	 ...
	 * 
	 * Estos dos métodos no forman parte del examen OCP sino del examen de actualización.
	 * 
	 * El método computeIfPresent realiza un calculo si la clave existe y toma como argumento la clave y una
	 * BiFunction.
	 * 
	 * El método computeIfAbsent realiza un calculo si la clave no existe o es un valor nulo y toma como argumento
	 * la clave i una Function.
	 * 
	 * Si la función de mapeo retorna un valor null, el método computeIfPresent(), la clave se elimina del mapa. Con
	 * el método computeIfAbsent() la clave no se llega a añadir nunca en el mapa.
	 * 
	 */
